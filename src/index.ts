...
app.post("/users", async (req: Request, res: Response) => {
    ...
    try {
        ...
        if (typeof id !== "string") {
            res.status(400)
            throw new Error("O tipo da Id deve ser texto")
        }
        ...
        if (typeof name !== "string") {
            res.status(400)
            throw new Error("O tipo da name deve ser texto")
        }

        if (typeof email !== "string") {
            res.status(400)
            throw new Error("O tipo do e-mail deve ser texto")
        }

        if (typeof password !== "string") {
            res.status(400)
            throw new Error("O tipo do password é texto")
        }
...
app.post("/products", async (req: Request, res: Response) => {
    ...
    try {
        ...
        if (typeof id !== "string") {
            res.status(400)
            throw new Error("O tipo da id é texto.")
        }
        ...
        if (typeof name !== "string") {
            res.status(400)
            throw new Error("o tipo do nome é texto.")
        }
        ...
        if (typeof description !== "string") {
            res.status(400)
            throw new Error("O tipo da descrição é texto.")
        }

        if (typeof image_url !== "string") {
            res.status(400)
            throw new Error("O tipo do endereço (url) da imagem é texto.")
        }
...
app.put("/products/:id", async (req: Request, res: Response) => {
    ...
    try {
        ...
        if (typeof newId != "string") {
            res.status(400)
            throw new Error("O 'id' deve ser texto")
        }
        ...
        if (typeof newName !== "string") {
            res.status(400)
            throw new Error("O 'name' deve ser texto.")
        }
        ...
        if (typeof newDescription !== "string") {
            res.status(400)
            throw new Error("A 'description' deve ser texto")
        }
